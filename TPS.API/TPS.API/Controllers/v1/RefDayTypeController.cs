...
namespace TPS.API.Controllers.v1
{
    ...
    [ApiVersion("2")]
    [ApiController]
    [Route("api/v{version:apiVersion}/refdaytype")]
    public class RefDayTypeController : ControllerBase
    {
        private readonly IRefDayTypeService _service;
        public RefDayTypeController(IRefDayTypeService service)
        {
            _service = service;
        }
        ...
        [HttpGet("getDayType")]
        //[Authorize]
        public ActionResult GetDayType(string id)
        {
        ...
        [HttpPost]
        //[Authorize]
        public ActionResult Create(RefDayType data)
        {
        ...
        [HttpPut]
        //[Authorize]
        public ActionResult Update(RefDayType data)
        {
