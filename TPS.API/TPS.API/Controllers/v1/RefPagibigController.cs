...
namespace TPS.API.Controllers.v1
{
    ...
    [ApiVersion("2")]
    [ApiController]
    [Route("api/v{version:apiVersion}/refpagibig")]
    public class RefPagibigController : ControllerBase
    {
        private readonly IRefPagibigService _service;
        public RefPagibigController(IRefPagibigService service)
        {
            _service = service;
        }
        ...
        [HttpGet("getPagibig")]
        //[Authorize]
        public ActionResult GetPagibig(string id)
        {
        ...
        [HttpPost]
        //[Authorize]
        public ActionResult Create(RefPagibig data)
        {
        ...
        [HttpPut]
        //[Authorize]
        public ActionResult Update(RefPagibig data)
        {
