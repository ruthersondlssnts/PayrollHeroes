...
namespace TPS.API.Controllers.v1
{
    ...
    [ApiVersion("2")]
    [ApiController]
    [Route("api/v{version:apiVersion}/tpsconfiguration")]
    public class TpsConfigurationController : ControllerBase
    {
        private readonly ITpsConfigurationService _service;
        public TpsConfigurationController(ITpsConfigurationService service)
        {
            _service = service;
        }
        ...
        [HttpGet("getTpsConfiguration")]
        //[Authorize]
        public ActionResult GetTpsConfiguration(string id)
        {
        ...
        [HttpPost]
        //[Authorize]
        public ActionResult Create(TpsConfiguration data)
        {
        ...
        [HttpPut]
        //[Authorize]
        public ActionResult Update(TpsConfiguration data)
        {
