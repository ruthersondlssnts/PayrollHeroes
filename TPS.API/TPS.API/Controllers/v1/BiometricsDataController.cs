...
namespace TPS.API.Controllers.v1
{
    ...
    [ApiVersion("2")]
    [ApiController]
    [Route("api/v{version:apiVersion}/biometricsdata")]
    public class BiometricsDataController : ControllerBase
    {
        private readonly IBiometricsService _service;
        public BiometricsDataController(IBiometricsService service)
        {
            _service = service;
        }
        ...
        [HttpGet("getBiometric")]
        //[Authorize]
        public ActionResult GetBiometric(string id)
        {
        ...
        [HttpPost]
        //[Authorize]
        public ActionResult Create(BiometricsData data)
        {
        ...
        [HttpPut]
        //[Authorize]
        public ActionResult Update(BiometricsData data)
        {
