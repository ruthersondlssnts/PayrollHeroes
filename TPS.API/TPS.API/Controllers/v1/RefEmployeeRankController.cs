...
namespace TPS.API.Controllers.v1
{
    ...
    [ApiVersion("2")]
    [ApiController]
    [Route("api/v{version:apiVersion}/refemployeerank")]
    public class RefEmployeeRankController : ControllerBase
    {
        private readonly IRefEmployeeRankService _service;
        public RefEmployeeRankController(IRefEmployeeRankService service)
        {
            _service = service;
        }
        ...
        [HttpGet("getEmployeeRank")]
        //[Authorize]
        public ActionResult GetEmployeeRank(string id)
        {
        ...
        [HttpPost]
        //[Authorize]
        public ActionResult Create(RefEmployeeRank data)
        {
        ...
        [HttpPut]
        //[Authorize]
        public ActionResult Update(RefEmployeeRank data)
        {
