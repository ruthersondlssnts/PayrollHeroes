...
namespace TPS.API.Controllers.v1
{
    ...
    [ApiVersion("2")]
    [ApiController]
    [Route("api/v{version:apiVersion}/employeebalance")]
    public class EmployeeBalanceController : ControllerBase
    {
        ...
        [HttpGet("getEmployeeBalance")]
        //[Authorize]
        public ActionResult GetEmployeeBalance(string id)
        {
        ...
        [Consumes("application/json")]
        [Produces("application/json")]
        [HttpGet("getEmployeeLeaveTypeBalance")]
        //[Authorize]
        public ActionResult GetEmployeeLeaveTypeBalance(string empId, string leaveId)
        {
            var result = _service.FindByEmployeeIdLeaveTypeId(empId, leaveId).Result;
            switch (result.StatusCode)
            {
                case Infrastructure.Enums.StatusCode.Success:
                    return Ok(result);
        ...
        [HttpPost]
        //[Authorize]
        public ActionResult Create(EmployeeBalance data)
        {
        ...
        [HttpPut]
        //[Authorize]
        public ActionResult Update(EmployeeBalance data)
        {
