...
{ 
    public interface IRequestLeave 
    {
        ...
        bool UpdateLeave(int employee_id, DateTime leave_date, decimal leave, int ref_leave_type_id);
        bool GetApprovedLeave(int employee_id, DateTime leave_date,out decimal leave, out int ref_leave_type_id);

        RequestLeaveEntity GetApprovedLeave(int employee_id, DateTime shiftdate, RequestLeaveEntity data);
